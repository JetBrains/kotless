...
object CertificateFactory : GenerationFactory<Application.DNS, CertificateFactory.Output> {
    ...
    override fun mayRun(entity: Application.DNS, context: GenerationContext) = context.output.check(context.schema.config.terraform, ProvidersFactory)

    override fun generate(entity: Application.DNS, context: GenerationContext): GenerationFactory.GenerationResult<Output> {
        val providers = context.output.get(context.schema.config.terraform, ProvidersFactory)
