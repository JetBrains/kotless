...
object LambdaMergeOptimizer : SchemaOptimizer {
     ...
     */
    fun merge(lambdas: Set<Lambda>, level: Optimization.MergeLambda): Map<Lambda, Lambda> = when (level) {
    ...
    override fun optimize(schema: Schema, optimization: Optimization): Schema {
        val mergedMap = merge(schema.lambdas, optimization.mergeLambda)
