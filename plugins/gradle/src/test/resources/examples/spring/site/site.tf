...
resource "aws_cloudwatch_event_rule" "autowarm_io_kotless_examples_page_0" {
  name = "spring-site-autowarm-io-kotless-examples-page-0"
...
resource "aws_s3_bucket_object" "eu_spring_site_s3_ktls_aws_intellij_net_static_css_highlight_style_css" {
  ...
  etag = filemd5("/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/css/highlight-style.css")
  key = "static/css/highlight-style.css"
  source = "/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/css/highlight-style.css"
}

resource "aws_s3_bucket_object" "eu_spring_site_s3_ktls_aws_intellij_net_static_css_kotless_site_css" {
  bucket = "eu.spring-site.s3.ktls.aws.intellij.net"
  content_type = "text/css"
  etag = filemd5("/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/css/kotless-site.css")
  key = "static/css/kotless-site.css"
  source = "/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/css/kotless-site.css"
}

resource "aws_s3_bucket_object" "eu_spring_site_s3_ktls_aws_intellij_net_static_favicon_apng" {
  bucket = "eu.spring-site.s3.ktls.aws.intellij.net"
  content_type = "image/apng"
  etag = filemd5("/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/favicon.apng")
  key = "static/favicon.apng"
  source = "/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/favicon.apng"
}

resource "aws_s3_bucket_object" "eu_spring_site_s3_ktls_aws_intellij_net_static_js_highlight_pack_js" {
  bucket = "eu.spring-site.s3.ktls.aws.intellij.net"
  content_type = "application/javascript"
  etag = filemd5("/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/js/highlight.pack.js")
  key = "static/js/highlight.pack.js"
  source = "/home/anstkras/cool_projects/kotless/examples/spring/site/src/main/resources/static/js/highlight.pack.js"
}

resource "aws_s3_bucket_object" "io_kotless_examples_page_0" {
  bucket = "eu.spring-site.s3.ktls.aws.intellij.net"
  etag = filemd5("/home/anstkras/cool_projects/kotless/examples/build/site/libs/site-0.1.7-beta-4-all.jar")
  key = "kotless-lambdas/spring-site-io-kotless-examples-page-0.jar"
  source = "/home/anstkras/cool_projects/kotless/examples/build/site/libs/site-0.1.7-beta-4-all.jar"
}

data "aws_acm_certificate" "spring_site_kotless_io" {
  provider = aws.us_east_1
  domain = "spring.site.kotless.io"
  statuses = ["ISSUED"]
}
...
output "application_url" {
  value = "https://spring.site.kotless.io"
}
