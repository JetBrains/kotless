...
object LambdaContainerHandlerSource {
    ...
    val filePath = "com/amazonaws/serverless/proxy/internal/LambdaContainerHandler.java"
    val data =
        //language=java
        """
            /*
            ...
            public abstract class LambdaContainerHandler<RequestType, ResponseType, ContainerRequestType, ContainerResponseType> {
                ...
                private static Logger log = LoggerFactory.getLogger(LambdaContainerHandler.class);
                ...
                private static void registerAfterBurner() {
                    log.info("Registering after burner is not supported by the Graal VM yet ! ");
                }
