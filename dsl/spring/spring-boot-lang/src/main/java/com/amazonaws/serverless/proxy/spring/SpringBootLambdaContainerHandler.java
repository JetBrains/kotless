    ...
    public void initialize()
        ...
        if (springWebApplicationType == WebApplicationType.SERVLET) {
            if (applicationContext instanceof ServletWebServerApplicationContext servletWebServerApplicationContext) {
                servletWebServerApplicationContext.setServletContext(getServletContext());
            } else if (applicationContext instanceof AnnotationConfigServletWebApplicationContext annotationConfigServletWebApplicationContext) {
                annotationConfigServletWebApplicationContext.setServletContext(getServletContext());
            } else {
                log.warn("Unsupported applicationContext of type: " + applicationContext.getClass().getName());
            }
