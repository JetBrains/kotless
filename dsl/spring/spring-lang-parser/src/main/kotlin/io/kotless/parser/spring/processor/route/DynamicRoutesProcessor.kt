...
import io.kotless.parser.utils.psi.visit
...
internal object DynamicRoutesProcessor : AnnotationProcessor<Unit>() {
    ...
    private fun visitMethodMappings(element: KtElement, binding: BindingContext, context: ProcessorContext) {
        element.visit(binding) { el, previous ->
            if (el is KtNamedFunction && el.isAnnotatedWith(binding, methodAnnotations)) {
            ...
            el !is KtFunction && el !is KtNamedFunction
        }
    }
